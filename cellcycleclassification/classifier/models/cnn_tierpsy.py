...
class CNN_tierpsy_roi48_original_multiclass(nn.Module):
    """
    Original Tierpsy network
    """
    roi_size = 48
    ...
    def __init__(self):
        ...
        self.fc_layers_with_dropout = nn.Sequential(
            ...
            nn.Linear(512, 64),
            nn.Dropout(p=0.5),
            nn.Linear(64, 4),  # end with 4 classes
            )
...
class CNN_tierpsy_roi48_original_multiclass_v6(nn.Module):
    """
    Original Tierpsy network
    halve channels in all conv layers
    fc nodes are 1/2 of original
    """
    roi_size = 48
    ...
    def __init__(self):
        ...
        self.fc_layers_with_dropout = nn.Sequential(
            ...
            nn.Linear(256, 32),
            nn.Dropout(p=0.5),
            nn.Linear(32, 4),  # end with 4 classes
            )
...
class CNN_tierpsy_roi48_original_multiclass_v7(nn.Module):
    """
    Original Tierpsy network
    1/4 channels in all conv layers
    fc nodes are 1/4 of original
    """
    roi_size = 48
    ...
    def __init__(self):
        ...
        self.fc_layers_with_dropout = nn.Sequential(
            ...
            nn.Linear(128, 16),
            nn.Dropout(p=0.5),
            nn.Linear(16, 4),  # end with 4 classes
            )
